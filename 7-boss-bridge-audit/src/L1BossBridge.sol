...
contract L1BossBridge is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public DEPOSIT_LIMIT = 100_000 ether; // e depositing tokens you cant do too may
    ...
    // q what happens if an account is disabled mid-flight??
    ...
    // if the vault approved the bridge, a user can steal funds from the vault?
    ...
    function sendToL1(uint8 v, bytes32 r, bytes32 s, bytes memory message) public nonReentrant whenNotPaused {
        ...
        // q slither said this s bad, is that okay?
